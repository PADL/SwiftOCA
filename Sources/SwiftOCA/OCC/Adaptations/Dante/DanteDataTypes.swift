...
/// DDP AES67 mode: `none` when the device cannot do AES67 at all.
public enum DanteAES67Mode: OcaUint8, Codable, Sendable, CaseIterable {
  case none = 0
  case enabled = 1
  case disabled = 2
}

/// OcaMediaTransportApplication.AdaptationData for Dante, carrying the device's AES67
/// mode and RTP settings. Provisional: AES70-23 has not yet defined this datatype.
/// Only `aes67Mode` is writable, and takes effect after a reboot.
public struct DanteMediaTransportApplicationAdaptationData: Ocp1TypedBlobRepresentable,
  Sendable, Equatable
{
  public var aes67Supported: OcaBoolean
  public var aes67Mode: DanteAES67Mode
  public var aes67RebootMode: DanteAES67Mode
  /// IPv4 multicast prefix for RTP transmit flows, dotted decimal
  public var rtpMulticastAddressPrefix: OcaString
  public var rtpDestinationPort: OcaUint16
  public var rtpFramesPerPacket: OcaUint16
  public var rtpReceiveLatency: OcaTimeInterval

  public init(
    aes67Supported: OcaBoolean = false,
    aes67Mode: DanteAES67Mode = .none,
    aes67RebootMode: DanteAES67Mode = .none,
    rtpMulticastAddressPrefix: OcaString = "",
    rtpDestinationPort: OcaUint16 = 0,
    rtpFramesPerPacket: OcaUint16 = 0,
    rtpReceiveLatency: OcaTimeInterval = 0
  ) {
    self.aes67Supported = aes67Supported
    self.aes67Mode = aes67Mode
    self.aes67RebootMode = aes67RebootMode
    self.rtpMulticastAddressPrefix = rtpMulticastAddressPrefix
    self.rtpDestinationPort = rtpDestinationPort
    self.rtpFramesPerPacket = rtpFramesPerPacket
    self.rtpReceiveLatency = rtpReceiveLatency
  }
}
