...
open class OcaMediaClock3: OcaAgent {
    ...
    public var mediaCoding: OcaProperty<OcaMediaCoding>.State

    @OcaProperty(
        propertyID: OcaPropertyID("3.7")
    )
    public var mediaStreamEndpoint: OcaProperty<OcaMediaStreamEndpoint>.State

    public internal(set) var timeSource: OcaTimeSource?
    public internal(set) var mediaClockManager: OcaMediaClockManager?
}
