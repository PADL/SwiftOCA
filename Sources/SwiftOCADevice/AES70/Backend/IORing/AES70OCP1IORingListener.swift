...
@AES70Device
public final class AES70OCP1IORingListener: AES70Listener {
    ...
    private var _controllers = [AES70OCP1IORingController]()
    ...
    public convenience init(
        ...
        try await self.init(address: storage, timeout: timeout, backlog: backlog)
    }
    ...
    public func start() async throws {
        ...
        let task = Task {
            ...
            for try await client in clients {
                let controller = try await AES70OCP1IORingController(socket: client)
    ...
    private func handleController(_ controller: AES70OCP1IORingController) async {
